...
String uname=(String)session1.getAttribute("uname");
	...
	Field f = new Field();
	f =(Field)request.getAttribute("f");
		...
		<article class="module width_full">
		  ...
		  <h3>字段</h3></header>
				<div class="module_content">
						<fieldset>
                        <label style="margin-top:1px">字段详情</label>
                            <fieldset style="width:95%; float:left;margin-left:2%;"> <!-- to make two field float next to one another, adjust values accordingly -->
                        <p><h4>字段名称:  ${f.fname }</h4>
                        <p>&nbsp;</p>
                        <p><h4>修改时间:  ${f.fdate }</h4>
                        <p>&nbsp;</p>
                        <p><h4>修改人:  ${f.author }</h4>
                        <p>&nbsp;</p>
                        <p><h4>所属预案:  ${f.planname }</h4>
                        <p>&nbsp;</p>
						</fieldset>
						</fieldset>
						<fieldset style="width:100%; float:left;">
							<label>内容</label>
							<fieldset style="width:96%; float:left; margin-left:2%;"> <!-- to make two field float next to one another, adjust values accordingly -->
                       <h4>${f.ftext}</h4> 
						</fieldset>
