		  ...
		  <h3>添加公告</h3>
			...
			<div class="module_content">
			  <div class="clear">
				  <p/>
                  <fieldset>
				    <label><span class="STYLE2">标题</span></label>
				    <input name="informtitle" type="text" value="请输入公告标题" onfocus="javascript:if(this.value=='请输入公告标题')this.value='';">
                    </fieldset>
					<fieldset>
				    <label><span class="STYLE2">正文</span></label>
                    <textarea name="informtext" rows="12" style="resize:none"  ></textarea>
				</fieldset>
				    <footer><span class="submit_link">
				      <input  name="submit3" type="submit" class="alt_btn" value="发布公告"> 
				     <a href="inform_add.jsp"> <input name="submit4" type="submit" value="重置"></a>
