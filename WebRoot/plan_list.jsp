...
<article class="module width_3_quarter">
  <header>
    <h3 class="tabs_involved">预案列表</h3>
  </header>
        ...
        <c:forEach  var="p" items="${plist}">
          <tr>
            ...
            <td><div class="divNoWrap2">
                	<c:out value="${p.ptype}"></c:out>
                    </div></td>
            <td><c:out value="${p.userid}"></c:out></td>
            <td><c:out value="${p.pdate}"></c:out></td>
            <td><a href="PlanCheckServlet?pid=${p.pid}"> <input type="image" src="images/icn_edit.png" title="Edit"></a>
          </tr>
          </c:forEach>
        </tbody>
      </table>
